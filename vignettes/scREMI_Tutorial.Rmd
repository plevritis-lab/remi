...
source("load_subfunctions.R")
load("curr.lr.filt.rda")
load("g.biogrid.rda")
load("pathway.genelist.rda")
load("pathway.genes.rda")
```

Read in HNSCC scRNA-seq atlas, rename cell types for consistency
```{r}
HNSCC <- readRDS("HNSCC_atlas-scRNA-seq-CITE-seq.rds")
