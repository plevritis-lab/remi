...
```{r}
source('/Users/ayu1/Documents/GitHub/cabernet/cabernet.R')
source('/Users/ayu1/Documents/GitHub/cabernet/cabernet_functions.R')
```

# Reading in U01 data from GEO
```{r}
exp.data <- read.table('/Users/ayu1/Documents/cabernet/processed_U01.tsv', header=T, row.names=1)
